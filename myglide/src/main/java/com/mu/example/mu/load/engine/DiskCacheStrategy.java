...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.mu.example.mu.load.data.DataFetcher} and the
   * {@link com.mu.example.mu.load.EncodeStrategy} of the
   * {@link com.mu.example.mu.load.ResourceEncoder} (if an
   * {@link com.mu.example.mu.load.ResourceEncoder} is available).
   */
   ...
   * com.mu.example.mu.load.ResourceEncoder} will use to encode the resource.
   */
