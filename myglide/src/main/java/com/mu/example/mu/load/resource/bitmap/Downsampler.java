...
import com.mu.example.mu.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link com.mu.example.mu.load.DecodeFormat} that will be used in conjunction
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "com.mu.example.mu.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link com.mu.example.mu.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("com.mu.example.mu.load.resource.bitmap.Downsampler.DownsampleStrategy",
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.mu.example.mu.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * provided  {@link com.mu.example.mu.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link com.mu.example.mu.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
