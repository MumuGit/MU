 ...
 */
/**
 * An {@link com.mu.example.mu.load.ResourceDecoder} that can decode a thumbnail frame
...
public class VideoBitmapDecoder implements ResourceDecoder<ParcelFileDescriptor, Bitmap> {
  ...
  public static final Option<Long> TARGET_FRAME = Option.disk(
      "com.mu.example.mu.load.resource.bitmap.VideoBitmapDecode.TargetFrame", DEFAULT_FRAME,
  ...
  public static final Option<Integer> FRAME_OPTION = Option.disk(
      "com.mu.example.mu.load.resource.bitmap.VideoBitmapDecode.FrameOption",
      null /*defaultValue*/,
