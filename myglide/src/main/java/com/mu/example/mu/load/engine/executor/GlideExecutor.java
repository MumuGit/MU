package com.mu.example.mu.load.engine.executor;
...
public final class GlideExecutor extends ThreadPoolExecutor {
   ...
   * prefix, and the
   * {@link com.mu.example.mu.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT}
   ...
   * and {@link com.mu.example.mu.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
   ...
   * com.mu.example.mu.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} to use to
