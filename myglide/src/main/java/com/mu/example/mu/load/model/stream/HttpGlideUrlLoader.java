...
import com.mu.example.mu.load.data.HttpUrlFetcher;
import com.mu.example.mu.load.model.GlideUrl;
import com.mu.example.mu.load.model.ModelCache;
 ...
 */
/**
 * An {@link com.mu.example.mu.load.model.ModelLoader} for translating {@link
 * com.mu.example.mu.load.model.GlideUrl} (http/https URLS) into {@link InputStream} data.
 */
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT = Option.memory(
      "com.mu.example.mu.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);
