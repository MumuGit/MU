 ...
 * {@link com.mu.example.mu.GlideBuilder} and registering
 * {@link com.mu.example.mu.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.mu.example.mu.load.ResourceDecoder)} for each
 * {@link com.mu.example.mu.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * com.mu.example.mu.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.mu.example.mu.samples.flickr.FlickrGlideModule"
 ...
 */
@Deprecated
public interface GlideModule extends RegistersComponents, AppliesOptions { }//生
