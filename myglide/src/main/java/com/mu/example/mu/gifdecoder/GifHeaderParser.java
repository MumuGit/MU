package com.mu.example.mu.gifdecoder;
...
import static com.mu.example.mu.gifdecoder.GifDecoder.STATUS_FORMAT_ERROR;
import static com.mu.example.mu.gifdecoder.GifFrame.DISPOSAL_NONE;
import static com.mu.example.mu.gifdecoder.GifFrame.DISPOSAL_UNSPECIFIED;

/**
 * A class responsible for creating {@link com.mu.example.mu.gifdecoder.GifHeader}s from data
