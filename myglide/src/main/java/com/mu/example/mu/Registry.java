...
import com.mu.example.mu.load.data.DataRewinder;
import com.mu.example.mu.load.data.DataRewinderRegistry;
import com.mu.example.mu.load.engine.DecodePath;
import com.mu.example.mu.load.engine.LoadPath;
...
import com.mu.example.mu.load.model.ModelLoaderRegistry;
import com.mu.example.mu.load.resource.transcode.ResourceTranscoder;
import com.mu.example.mu.load.resource.transcode.TranscoderRegistry;
import com.mu.example.mu.provider.EncoderRegistry;
import com.mu.example.mu.provider.ImageHeaderParserRegistry;
import com.mu.example.mu.provider.LoadPathCache;
import com.mu.example.mu.provider.ModelToResourceClassCache;
import com.mu.example.mu.provider.ResourceDecoderRegistry;
import com.mu.example.mu.provider.ResourceEncoderRegistry;
...
public class Registry {
  ...
  /**
   * Use the given factory to build a {@link com.mu.example.mu.load.model.ModelLoader} for models
  ...
  /**
   * Thrown when no {@link com.mu.example.mu.load.model.ModelLoader} is registered for a given
   * model class.
   */
