 ...
 */
/**
 * A simple {@link com.mu.example.mu.load.Transformation} for transforming
 * {@link Bitmap}s that abstracts away dealing with
 * {@link com.mu.example.mu.load.engine.Resource} objects for subclasses.
 *
 * Use cases will look something like this:
 * <pre>
 * <code>
 * public class FillSpace extends BaseBitmapTransformation {
 *     private static final String ID = "com.mu.example.mu.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   * {@link com.mu.example.mu.request.target.Target#SIZE_ORIGINAL},
   * this class converts them to be the size of the Bitmap we're going to transform before calling
   * this method.
   *
   * @param pool        A {@link com.mu.example.mu.load.engine.bitmap_recycle.BitmapPool} that can
