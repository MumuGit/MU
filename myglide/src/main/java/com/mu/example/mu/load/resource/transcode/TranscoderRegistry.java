 ...
 */
/**
 * A class that allows {@link com.mu.example.mu.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link com.mu.example.mu.load.resource.transcode.ResourceTranscoder} using
   ...
   * {@link com.mu.example.mu.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
