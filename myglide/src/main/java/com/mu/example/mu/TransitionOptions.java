...
import com.mu.example.mu.request.transition.NoTransition;
import com.mu.example.mu.request.transition.TransitionFactory;
import com.mu.example.mu.request.transition.ViewAnimationFactory;
import com.mu.example.mu.request.transition.ViewPropertyAnimationFactory;
import com.mu.example.mu.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link com.mu.example.mu.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
