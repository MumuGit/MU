...
import com.mu.example.mu.load.engine.DiskCacheStrategy;
import com.mu.example.mu.request.FutureTarget;
import com.mu.example.mu.request.Request;
import com.mu.example.mu.request.RequestCoordinator;
import com.mu.example.mu.request.RequestFutureTarget;
import com.mu.example.mu.request.RequestListener;
import com.mu.example.mu.request.RequestOptions;
import com.mu.example.mu.request.SingleRequest;
import com.mu.example.mu.request.ThumbnailRequestCoordinator;
import com.mu.example.mu.request.target.PreloadTarget;
import com.mu.example.mu.request.target.Target;
import com.mu.example.mu.signature.ApplicationVersionSignature;
...
import static com.mu.example.mu.request.RequestOptions.signatureOf;
/**
 * tnormal
 */
/**
 ...
 * {@link com.mu.example.mu.request.target.Target}.
 */
public class RequestBuilder<TranscodeType> implements Cloneable {
   ...
   * com.mu.example.mu.load.model.ModelLoader}, {@link com.mu.example.mu.load.ResourceDecoder},
   * and {@link com.mu.example.mu.load.Transformation}s. However,
   * {@link com.mu.example.mu.request.RequestOptions#placeholder(int)} and
   * {@link com.mu.example.mu.request.RequestOptions#error(int)}, and
   ...
   * {@link #into(com.mu.example.mu.request.target.Target)} is called. </p>
   *
   ...
   * {@link com.mu.example.mu.request.RequestOptions#signature(com.mu.example.mu.load.Key)} to
   ...
   * {@link com.mu.example.mu.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link com.mu.example.mu.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link com.mu.example.mu.load.model.UriLoader}.
   */
   ...
   * {@link com.mu.example.mu.request.RequestOptions#signature(com.mu.example.mu.load.Key)}
   ...
   * the {@link com.mu.example.mu.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link com.mu.example.mu.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * using {@link com.mu.example.mu.load.engine.DiskCacheStrategy#NONE} via
   * {@link RequestOptions#diskCacheStrategy(com.mu.example.mu.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link com.mu.example.mu.load.engine.DiskCacheStrategy#RESOURCE} for release builds. </p>
   *
   * @see #load(Integer)
   * @see com.mu.example.mu.signature.ApplicationVersionSignature
   */
   ...
   * @return The
   * {@link com.mu.example.mu.request.target.Target} used to wrap the given {@link ImageView}.
   */
   ...
   *               overridden by
   *               {@link com.mu.example.mu.request.RequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see com.mu.example.mu.ListPreloader
   */
