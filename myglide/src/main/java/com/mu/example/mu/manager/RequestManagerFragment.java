 ...
 * com.mu.example.mu.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.mu.example.mu.manager.SupportRequestManagerFragment
 * @see com.mu.example.mu.manager.RequestManagerRetriever
 * @see com.mu.example.mu.RequestManager
 */
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.mu.example.mu.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link com.mu.example.mu.RequestManager} or null if none exists.
   */
  @Nullable
