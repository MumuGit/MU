...
import com.mu.example.mu.TransitionOptions;
import com.mu.example.mu.request.transition.BitmapTransitionFactory;
import com.mu.example.mu.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see com.mu.example.mu.GenericTransitionOptions#with(TransitionFactory)
   */
   ...
   * @see com.mu.example.mu.request.transition.DrawableCrossFadeFactory.Builder
   */
