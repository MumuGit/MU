...
import com.mu.example.mu.Priority;
...
import com.mu.example.mu.load.resource.bitmap.BitmapDrawableTransformation;
import com.mu.example.mu.load.resource.bitmap.BitmapEncoder;
import com.mu.example.mu.load.resource.bitmap.CenterCrop;
import com.mu.example.mu.load.resource.bitmap.CenterInside;
import com.mu.example.mu.load.resource.bitmap.CircleCrop;
import com.mu.example.mu.load.resource.bitmap.DownsampleStrategy;
import com.mu.example.mu.load.resource.bitmap.Downsampler;
import com.mu.example.mu.load.resource.bitmap.FitCenter;
...
import com.mu.example.mu.load.resource.gif.GifDrawableTransformation;
import com.mu.example.mu.load.resource.gif.StreamGifDecoder;
import com.mu.example.mu.signature.EmptySignature;
...
public class RequestOptions implements Cloneable {
  ...
  /**
   * Returns a {@link com.mu.example.mu.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link com.mu.example.mu.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
  ...
  /**
   * Applies a multiplier to the {@link com.mu.example.mu.request.target.Target}'s size before
   ...
   *                       {@link com.mu.example.mu.request.target.Target}'s dimensions when
   ...
   * {@link com.mu.example.mu.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.mu.example.mu.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.mu.example.mu.signature.ObjectKey
   */
   ...
   * {@link com.mu.example.mu.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  ...
  /**
   * Applies {@link com.mu.example.mu.load.resource.bitmap.CenterCrop} to all default types, and
  ...
  /**
   * Applies {@link com.mu.example.mu.load.resource.bitmap.FitCenter} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies {@link com.mu.example.mu.load.resource.bitmap.CenterInside} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   ...
   * {@link com.mu.example.mu.load.resource.gif.GifDrawable})
   ...
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link BitmapDrawable}, and
   * {@link com.mu.example.mu.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link Context}.
   ...
   * {@link com.mu.example.mu.TransitionOptions#dontTransition()}</p>
   */
