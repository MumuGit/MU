package com.mu.example.mu.util;

import android.view.View;

import com.mu.example.mu.ListPreloader;
 ...
 */
/**
 * A {@link com.mu.example.mu.ListPreloader.PreloadSizeProvider} that will extract the preload size
