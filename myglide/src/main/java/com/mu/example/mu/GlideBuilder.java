...
import com.mu.example.mu.load.engine.bitmap_recycle.LruArrayPool;
import com.mu.example.mu.load.engine.bitmap_recycle.LruBitmapPool;
import com.mu.example.mu.load.engine.cache.DiskCache;
import com.mu.example.mu.load.engine.cache.InternalCacheDiskCacheFactory;
import com.mu.example.mu.load.engine.cache.LruResourceCache;
import com.mu.example.mu.load.engine.cache.MemoryCache;
import com.mu.example.mu.load.engine.cache.MemorySizeCalculator;
import com.mu.example.mu.load.engine.executor.GlideExecutor;
import com.mu.example.mu.manager.ConnectivityMonitorFactory;
import com.mu.example.mu.manager.DefaultConnectivityMonitorFactory;
import com.mu.example.mu.manager.RequestManagerRetriever;
import com.mu.example.mu.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link com.mu.example.mu.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link com.mu.example.mu.load.engine.cache.MemoryCache} implementation to store
   * {@link com.mu.example.mu.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link com.mu.example.mu.load.engine.cache.DiskCache} implementation to use to store
   * {@link com.mu.example.mu.load.engine.Resource} data and thumbnails.
   *
   ...
   * use {@link #setDiskCache(com.mu.example.mu.load.engine.cache.DiskCache.Factory)} instead.
  ...
  /**
   * Sets the {@link com.mu.example.mu.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link com.mu.example.mu.load.engine.cache.DiskCache} to use to store {@link
   * com.mu.example.mu.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.mu.example.mu.load.engine.Resource}s that are not already in the cache.
   *
   * <p> Any implementation must order requests based on their {@link com.mu.example.mu.Priority}
  ...
  /**
   * Sets the {@link java.util.concurrent.ExecutorService} implementation to use when retrieving
   * {@link com.mu.example.mu.load.engine.Resource}s that are currently in cache.
   *
   * <p> Any implementation must order requests based on their {@link com.mu.example.mu.Priority}
   * for thumbnail requests to work properly.
   *
  ...
  /**
   * Sets the {@link com.mu.example.mu.load.DecodeFormat} that will be the default format for all
   ...
   * com.mu.example.mu.load.DecodeFormat} for more details. </p>
   *
  ...
  /**
   * Sets the {@link com.mu.example.mu.manager.ConnectivityMonitorFactory}
   * to use to notify {@link com.mu.example.mu.RequestManager} of connectivity events.
   * If not set {@link com.mu.example.mu.manager.DefaultConnectivityMonitorFactory} would be used.
   *
