...
import com.mu.example.mu.load.resource.drawable.DrawableTransitionOptions;
import com.mu.example.mu.load.resource.gif.GifDrawable;
import com.mu.example.mu.manager.ConnectivityMonitor;
import com.mu.example.mu.manager.ConnectivityMonitorFactory;
import com.mu.example.mu.manager.Lifecycle;
import com.mu.example.mu.manager.LifecycleListener;
import com.mu.example.mu.manager.RequestManagerTreeNode;
import com.mu.example.mu.manager.RequestTracker;
import com.mu.example.mu.manager.TargetTracker;
...
import com.mu.example.mu.request.target.ViewTarget;
import com.mu.example.mu.request.transition.Transition;
import com.mu.example.mu.util.Synthetic;
import com.mu.example.mu.util.Util;

import java.io.File;

import static com.mu.example.mu.request.RequestOptions.decodeTypeOf;
import static com.mu.example.mu.request.RequestOptions.diskCacheStrategyOf;
import static com.mu.example.mu.request.RequestOptions.skipMemoryCacheOf;
/**
 * tnormal
 */
/**
...
public class RequestManager implements LifecycleListener {
   ...
   * com.mu.example.mu.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
   ...
   * com.mu.example.mu.load.engine.DiskCacheStrategy#DATA}. As a result, specifying a
   * {@link com.mu.example.mu.load.engine.DiskCacheStrategy} on this request is generally not
   * recommended.
   *
   ...
   * {@link com.mu.example.mu.load.ResourceDecoder}s
