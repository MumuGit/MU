...
import static com.mu.example.mu.gifdecoder.GifDecoder.TOTAL_ITERATION_COUNT_FOREVER;
/**
 * tnormal
 */
/**
...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param bitmapPool          A {@link com.mu.example.mu.load.engine.bitmap_recycle.BitmapPool}
   *                            that can be used to return the first frame when this drawable is
   *                            recycled.
   * @param frameTransformation An {@link com.mu.example.mu.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(com.mu.example.mu.load.Transformation, Bitmap)
   */
