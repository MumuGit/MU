 ...
 */
/**
 * An {@link com.mu.example.mu.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@link com.mu.example.mu.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s
