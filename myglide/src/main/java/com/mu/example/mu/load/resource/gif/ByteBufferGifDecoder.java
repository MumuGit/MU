...
import com.mu.example.mu.gifdecoder.GifHeader;
import com.mu.example.mu.gifdecoder.GifHeaderParser;
import com.mu.example.mu.gifdecoder.StandardGifDecoder;
...
import com.mu.example.mu.load.resource.UnitTransformation;
...
/**
 * An {@link com.mu.example.mu.load.ResourceDecoder} that decodes {@link
 * com.mu.example.mu.load.resource.gif.GifDrawable} from {@link java.io.InputStream} data.
 */
