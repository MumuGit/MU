...
import com.mu.example.myapplication.okhttp3.CacheControl;
...
public final class CacheStrategy {
    ...
    public static class Factory {
        ...
        private CacheStrategy getCandidate() {
            ...
            if (!responseCaching.noCache() && ageMillis + minFreshMillis < freshMillis + maxStaleMillis) {
                ...
                if (ageMillis > oneDayMillis && isFreshnessLifetimeHeuristic()) {
                    builder.addHeader("Warning", "113 HttpConnetion \"Heuristic expiration\"");
                }
        ...
        private long cacheResponseAge() {
            long apparentReceivedAge = servedDate != null ? Math.max
                    (0, receivedResponseMillis - servedDate.getTime()) : 0;
            long receivedAge = ageSeconds != -1 ? Math.max(apparentReceivedAge, SECONDS.toMillis(ageSeconds)) :
                    apparentReceivedAge;
            long reponseDuration = receivedResponseMillis - sentRequestMillis;
            long residentDuration = nowMillis - receivedResponseMillis;
            return receivedAge + reponseDuration + residentDuration;
        }
