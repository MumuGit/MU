package com.mu.example.myapplication.okhttp3;
...
public class Address {
    ...
    public Address(String uriHost, String uriPort, Dns dns, SocketFactory socketFactory,
    ...
    /**
     * Returns this address's proxy selector.Only used if the proxy is null.If none of
     * this seletor's proxies are reachable, a direct connection will be attempted.
     */
    ...
    public boolean equals(@Nullable Object other) {
        return other instanceof Address && url.equals(((Address) other).url)
