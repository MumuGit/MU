...
import com.mu.example.myapplication.okhttp3.ConnectionSpec;
...
public final class ConnectionSpecSelector {
    ...
    public ConnectionSpec configureSecureSocket(SSLSocket sslSocket) throws IOException {
        ...
        if (tlsConfiguration == null) {
            ...
            throw new UnknownServiceException("Unable to find acceptable protocols.isFallback=" + isFallback
                    + ",modes=" + connectionSpecs + ",supported protocols=" + Arrays.toString(sslSocket.getEnabledProtocols()));
        }
    ...
    public boolean connectionFailed(IOException e) {
        ...
        return (e instanceof SSLHandshakeException || e instanceof ProtocolException);
    }
