package com.mu.example.fine_gesture_dector;
...
public class FineGestureDetector {
    /**
     ...
     */
    public FineGestureDetector(Context context, OnGestureListener listener) {
     ...
     * @see android.os.Handler#Handler()
     */
    public FineGestureDetector(Context context, OnGestureListener listener, Handler handler) {
        if (handler != null) {
